...
import Loader from '../components/Loader'; // Loader già importato qui!
                ...
                <div className="w-full md:w-auto mt-8 md:mt-0">
                    ...
                    <div className="flex justify-end">
                        <div className="grid grid-cols-2 gap-3" style={{ width: '240px' }}> 
                            ...
                            {/* Box 1: Visitati */}
                            <div className="bg-white/10 p-3 rounded-xl backdrop-blur-sm hover:bg-white/20 transition flex flex-col justify-center items-center aspect-square">
